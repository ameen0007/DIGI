...
export const Section5 = () => {
  ...
  const handleCallButtonClick = () => {
    window.location.href = "+917034347895"; // Replace +1234567890 with your phone number
  };

  const handleEmailButtonClick = () => {
    window.location.href = "mailto:digievosolutions01@gmail.com"; // Replace example@example.com with your email address
  };
  const handleWhatsAppButtonClick = () => {
    const phoneNumber = '917034347895';
